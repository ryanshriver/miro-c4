...
This Miro app exports visual C4 diagrams into YAML formatted text that becomes input context for GenAI tools. 

Built as a companion for my DDD: Discover Systems with C4 Miro template, the goal is to provide a one-click way to export Context and Container diagrams then use AI to modernize the architecture.
